...
longitudinal.svm <- svm(Demented ~ ., data = longitudinal.train, kernel = "linear")
yhat.svm <- predict(longitudinal.svm, newdata = longitudinal.test)
table(pred = yhat.svm, truth = longitudinal.test$Demented) # 0.8648649
