...
data that lies in the margin of the boundary seperating the prediction space in the model. 
...
Need to test with both gamma and cost simultaneously as these parameters are correlated.
...
print(nodelt.svm[29])
```
We get accuracies of approx. 71 and 75 for the data sets respectively. 
