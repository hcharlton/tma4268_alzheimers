...
Feature selection with logistic regression identified Age, MMSE, nWBV, and dMMSE as the best subset with AIC. For random forests, 5000 trees with 3 random predictors had the lowest OOB error, while support vector machines with a radial kernel, cost-function of 100, and gamma = 0.01 had the lowest CV-error. 
We matched the three models against one another, where logistic regression and random forests outperformed SVM, with logistic regression being the best of the three based on a 5-fold CV.
 In the end, we tested the logistic regression model on our test data...
